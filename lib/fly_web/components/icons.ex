defmodule FlyWeb.Components.Icons do
  ...
  def render(%{type: :loading} = assigns) do
    ~H"""
    <div class="grid place-items-center h-screen relative">
      <svg xmlns="http://www.w3.org/2000/svg" class="animate-reverse-spin absolute top-64 h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
